...
public class Unit {
	 ...
	 */
	/**
	 * Liefert die Geschwindigkeit des Objektes in X und Y Richtung. speed[0] ist die Geschwindikeit in X Richtung; speed[1] ist die Geschwindikeit in Y Richtung; Wertebereich: 10 bis -10, wobei 0 keine Bewegung bedeutet.  X -10 bis 10. -10 steht für maximale Bewegung zur Negativen x Richtung (Nach links ^^). +10 Max nach rechts. Y (das selbe wie bei X)  -10 bis 10. -10 steht für maximale Bewegung zur Negativen y Richtung (Nach unten ^^) +10 max geschwindigkeit nach oben
